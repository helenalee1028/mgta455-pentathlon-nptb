...
X_train = as.matrix(pentathlon_nptb_xgb_train)
y_train = as.matrix(pentathlon_nptb_xgb_train$buyer)

X_test = as.matrix(pentathlon_nptb_xgb_test)
y_test =as.matrix(pentathlon_nptb_xgb_test$buyer) 
